...
@php
    $classes = \Illuminate\Support\Arr::toCssClasses([
        'relative text-sm w-full rounded-2xl border max-w-xl bg-white p-4 [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg+div]:translate-y-[-3px] [&:has(svg)]:pl-11 text-neutral-900',
