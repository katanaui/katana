...
@php
    $classes = \Illuminate\Support\Arr::toCssClasses([
        ...
        'text-rose-600 bg-white dark:bg-rose-500 dark:border-rose-400 bg-rose-50 dark:text-stone-100 border-rose-200' => $variant === 'destructive',
        'text-blue-600 bg-white dark:bg-blue-500 dark:border-blue-400 bg-blue-50 dark:text-stone-100 border-blue-200' => $variant === 'info',
        'text-green-600 bg-white dark:bg-green-500 dark:border-green-400 bg-green-50 dark:text-stone-100 border-green-300' => $variant === 'success',
        'text-amber-700 bg-white dark:bg-amber-600 dark:border-amber-500 bg-amber-50 dark:text-amber-100 border-amber-300' => $variant === 'warning',
    ]);
@endphp
