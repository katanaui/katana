...
<{!! $typeAttr !!} {{ $attributes->twMerge($sizeClasses . ' ' . $typeClasses . ' cursor-pointer border inline-flex rounded-(--radius) items-center justify-center items-center font-medium focus:outline-none') }}>
